...
2. Break templates into reusable partials
3. Use Glide for responsive images
4. Enable static caching for production
5. Commit content files for version control
